...
class AppointmentExportController extends Controller
{
    ...
    public function export(Request $request): StreamedResponse
    {
        ...
        $filename = 'appointments_export_'.now()->format('Y-m-d_His').'.xlsx';

        return Excel::download(
            new AppointmentExport(
                clinicId: $clinicId,
    ...
    public function exportPdf(Request $request): StreamedResponse
    {
        ...
        $filename = 'appointments_export_'.now()->format('Y-m-d_His').'.pdf';
