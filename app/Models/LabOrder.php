...
class LabOrder extends BaseModel
{
    ...
    public const ALLOWED_TRANSITIONS = [
        self::STATUS_ORDERED => [self::STATUS_SAMPLE_COLLECTED, self::STATUS_RESULTED, self::STATUS_CANCELED],
        self::STATUS_SAMPLE_COLLECTED => [self::STATUS_RESULTED, self::STATUS_CANCELED],
        self::STATUS_RESULTED => [],
        self::STATUS_CANCELED => [],
    ];
