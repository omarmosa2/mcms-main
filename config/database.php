...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | When DB_REPLICA_ENABLED is true, SELECT queries will be routed to the
    | read replica while INSERT/UPDATE/DELETE go to the primary database.
    |
    */
