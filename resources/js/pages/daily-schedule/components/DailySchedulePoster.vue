...
<template>
    ...
    >
        ...
        />
        <div
            class="pointer-events-none absolute inset-x-0 top-28 -z-10 h-24 opacity-[0.09]"
            aria-hidden="true"
        >
        ...
        <div
            class="pointer-events-none absolute top-10 left-8 -z-10 text-7xl font-black text-[#1d7de9]/[0.06]"
        >
            +
        </div>
        <div
            class="pointer-events-none absolute right-10 bottom-24 -z-10 text-8xl font-black text-[#e02f89]/[0.06]"
        >
            +
        </div>
        ...
        >
            ...
            >
                <div class="flex items-center gap-4">
                    ...
                    <div class="min-w-0">
                        ...
                        <h2
                            class="mt-1 text-2xl leading-tight font-extrabold text-[#12345a] sm:text-3xl"
                        >
                            {{ clinicName }}
                        </h2>
                        <p
                            v-if="scheduleData.clinic_settings.name"
                            class="mt-1 text-sm font-medium text-[#66768a]"
                        >
                ...
                <div class="text-center">
                    <h1
                        class="text-4xl leading-tight font-black text-[#12345a] sm:text-5xl"
                    >
                        العيادات المناوبة
                    </h1>
                    <div
                ...
                <div class="flex justify-start lg:justify-end">
                    <div
                        class="rounded-3xl border border-[#cfe2f3] bg-[#eef7ff] px-5 py-4 text-start"
                    >
                        <p class="text-xs font-bold text-[#5f7891]">
                            تاريخ الدوام
                        </p>
                        <p
                            class="mt-1 text-lg font-extrabold text-[#12345a] tabular-nums"
                        >
            ...
            >
                ...
                >
                    <div class="flex items-start gap-4">
                        ...
                        >
                            <component
                                :is="iconForClinic(clinic)"
                                class="size-8 text-[#fbfdff]"
                            />
                        </div>
                        <div class="min-w-0 flex-1">
                            ...
                            >
                                <div>
                                    <h3
                                        class="text-2xl leading-tight font-extrabold text-[#12345a]"
                                    >
                                        {{ clinic.name }}
                                    </h3>
                                    <p
                                        v-if="clinic.clinic_type"
                                        class="mt-1 text-sm font-semibold text-[#6a7a8c]"
                                    >
                                        {{ clinic.clinic_type }}
                                    </p>
                                </div>
                        ...
                        >
                            ...
                            >
                                <div class="flex min-w-0 items-center gap-3">
                                    ...
                                    <div class="min-w-0">
                                        <p
                                            class="text-lg leading-tight font-extrabold text-[#172033]"
                                        >
                                            {{ doctor.doctor_name }}
                                        </p>
                                        <p
                                            v-if="doctor.specialty"
                                            class="mt-1 text-sm font-semibold text-[#6b7888]"
                                        >
                                            {{ doctor.specialty }}
                                        </p>
                                    </div>
            ...
            >
                <div
                    class="flex size-20 items-center justify-center rounded-full bg-[#eff8ff]"
                >
            ...
            <div class="grid gap-3 md:grid-cols-3">
                <div
                    class="flex items-center gap-3 rounded-2xl border border-[#dbe8ef] bg-[#f7fbfd] px-4 py-3"
                >
            ...
            <footer
                class="grid gap-3 rounded-[1.5rem] bg-[#12345a] p-4 text-[#fbfdff] md:grid-cols-2"
            >
                <div
                    class="flex items-center gap-3 rounded-2xl bg-[#fbfdff]/10 px-4 py-3"
                >
