        ...
        <DialogContent class="max-w-[520px] p-0 overflow-hidden">
            ...
            >
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="flex flex-col gap-1.5">
                        <Label for="first_name" class="text-sm font-medium text-[#374151]">
                            الاسم الأول
                    ...
                    <div class="flex flex-col gap-1.5">
                        <Label for="last_name" class="text-sm font-medium text-[#374151]">
                            اسم العائلة
                            <span class="text-[#DC2626] mr-1">*</span>
                        </Label>
                        <Input
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="flex flex-col gap-1.5">
                        <Label for="date_of_birth" class="text-sm font-medium text-[#374151]">تاريخ الميلاد</Label>
                        <Input
                            id="date_of_birth"
                            name="date_of_birth"
                            type="date"
                    ...
                    <div class="flex flex-col gap-1.5">
                        <Label for="gender" class="text-sm font-medium text-[#374151]">الجنس</Label>
                        <select
                            id="gender"
                            name="gender"
                ...
                <div class="flex flex-col gap-1.5">
                    <Label for="phone" class="text-sm font-medium text-[#374151]">الهاتف</Label>
                    <Input
                        id="phone"
                        name="phone"
                        class="w-full h-10 rounded-lg border border-[#E5E7EB] bg-white px-3 text-sm text-[#1A1A1A] placeholder:text-[#9CA3AF] focus:outline-none focus:border-[#0EA5E9] focus:ring-2 focus:ring-[#0EA5E9]/10 transition-colors"
                ...
                <div class="flex flex-col gap-1.5">
                    <Label for="email" class="text-sm font-medium text-[#374151]">البريد الإلكتروني</Label>
                    <Input
                        id="email"
                        name="email"
                        type="email"
                ...
                <div class="flex flex-col gap-1.5">
                    <Label for="national_id" class="text-sm font-medium text-[#374151]">رقم الهوية</Label>
                    <Input
                        id="national_id"
                        name="national_id"
                        class="w-full h-10 rounded-lg border border-[#E5E7EB] bg-white px-3 text-sm text-[#1A1A1A] placeholder:text-[#9CA3AF] focus:outline-none focus:border-[#0EA5E9] focus:ring-2 focus:ring-[#0EA5E9]/10 transition-colors"
                ...
                <div class="flex flex-col gap-1.5">
                    <Label for="notes" class="text-sm font-medium text-[#374151]">ملاحظات</Label>
                    <textarea
                        id="notes"
                        name="notes"
                        rows="3"
                        class="w-full rounded-lg border border-[#E5E7EB] bg-white px-3 py-2 text-sm text-[#1A1A1A] focus:outline-none focus:border-[#0EA5E9] focus:ring-2 focus:ring-[#0EA5E9]/10 transition-colors resize-y"
                    ></textarea>
                ...
                <div class="flex flex-col gap-2 rounded-xl border border-[#E5E7EB] bg-[#F9FAFB] p-3">
                    <div class="flex items-center justify-between gap-2">
                        ...
                        <Button type="button" size="sm" variant="outline" class="h-9 px-3 text-xs rounded-lg border border-[#E5E7EB] bg-white text-[#6B7280] hover:bg-[#F9FAFB] hover:text-[#1A1A1A]" @click="addMedicalItem(createChronicConditions)">إضافة</Button>
                    </div>
                    <div v-for="(item, index) in createChronicConditions" :key="`create-chronic-${index}`" class="flex items-center gap-2">
                        <Input
                            ...
                            class="w-full h-10 rounded-lg border border-[#E5E7EB] bg-white px-3 text-sm text-[#1A1A1A] placeholder:text-[#9CA3AF] focus:outline-none focus:border-[#0EA5E9] focus:ring-2 focus:ring-[#0EA5E9]/10 transition-colors"
                        />
                        <Button type="button" size="sm" variant="ghost" class="h-9 px-3 text-xs text-[#6B7280] hover:bg-[#F9FAFB] hover:text-[#1A1A1A]" @click="removeMedicalItem(createChronicConditions, index)">حذف</Button>
                    </div>
                ...
                <div class="flex flex-col gap-2 rounded-xl border border-[#E5E7EB] bg-[#F9FAFB] p-3">
                    <div class="flex items-center justify-between gap-2">
                        ...
                        <Button type="button" size="sm" variant="outline" class="h-9 px-3 text-xs rounded-lg border border-[#E5E7EB] bg-white text-[#6B7280] hover:bg-[#F9FAFB] hover:text-[#1A1A1A]" @click="addMedicalItem(createAllergies)">إضافة</Button>
                    </div>
                    <div v-for="(item, index) in createAllergies" :key="`create-allergy-${index}`" class="flex items-center gap-2">
                        <Input
                            ...
                            class="w-full h-10 rounded-lg border border-[#E5E7EB] bg-white px-3 text-sm text-[#1A1A1A] placeholder:text-[#9CA3AF] focus:outline-none focus:border-[#0EA5E9] focus:ring-2 focus:ring-[#0EA5E9]/10 transition-colors"
                        />
                        <Button type="button" size="sm" variant="ghost" class="h-9 px-3 text-xs text-[#6B7280] hover:bg-[#F9FAFB] hover:text-[#1A1A1A]" @click="removeMedicalItem(createAllergies, index)">حذف</Button>
                    </div>
                ...
                <div class="flex flex-col gap-2 rounded-xl border border-[#E5E7EB] bg-[#F9FAFB] p-3">
                    <div class="flex items-center justify-between gap-2">
                        ...
                        <Button type="button" size="sm" variant="outline" class="h-9 px-3 text-xs rounded-lg border border-[#E5E7EB] bg-white text-[#6B7280] hover:bg-[#F9FAFB] hover:text-[#1A1A1A]" @click="addMedicalItem(createCurrentMedications)">إضافة</Button>
                    </div>
                    <div v-for="(item, index) in createCurrentMedications" :key="`create-medication-${index}`" class="flex items-center gap-2">
                        <Input
                            ...
                            class="w-full h-10 rounded-lg border border-[#E5E7EB] bg-white px-3 text-sm text-[#1A1A1A] placeholder:text-[#9CA3AF] focus:outline-none focus:border-[#0EA5E9] focus:ring-2 focus:ring-[#0EA5E9]/10 transition-colors"
                        />
                        <Button type="button" size="sm" variant="ghost" class="h-9 px-3 text-xs text-[#6B7280] hover:bg-[#F9FAFB] hover:text-[#1A1A1A]" @click="removeMedicalItem(createCurrentMedications, index)">حذف</Button>
                    </div>
